        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- item name input -->
                    <h6>Hoe heet het item wat u wilt bestellen</h6>
                    ...
                    <!-- amount input -->
                    <form>
                        <label for="quantity">Hoeveel items wilt u bestellen:</label>
                    ...
                    <div class="modal-footer">
                        <!-- submit button -->
                    <button type="submit" name="submit" class="btn btn-secondary btn-lg btn-block">order item</button>
                    </form>     
                    </div>
                </div>
            </div>
